...
export default function SideBar(props) {
  ...
  return (
    <aside className="sm:w-75 w-[50%] overflow-hidden border-r-2 border-[#3525cd] h-screen flex flex-col gap-5">
      <div className="ml-2">
        <h1 className="text-[#3525cd] text-[24px] font-bold tracking-tight">
          ZenNote
        </h1>
        <p className="text-md tracking-tight font-bold text-lg">Welcome, {props.userId ?? 'User'}</p>
      </div>
      ...
      <span className="ml-2 border-b border-[#d9dadb] w-[calc(100%-20px)] font-bold">Notes</span>
